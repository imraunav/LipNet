...
#SBATCH --job-name=LipNet-conv2d  #change name of ur job
#SBATCH --output=output.conv2d  #change name of ur output file
...
CUDA_VISIBLE_DEVICES=0,1 python train-conv2.py
