...
def main(rank, world_size):
    ...
    model.load_state_dict(torch.load("weights/LipNet_unseen_loss_0.44562849402427673_wer_0.1332580699113564_cer_0.06796452465503355.pt", map_location=torch.device(rank)))
    trainer = TrainerDDP(
        gpu_id=rank,
        model=model,
